...
class Store{
  ...
  defaults(){return {modelsDir:path.join(os.homedir(),'BotConnector AI','models'),runtimeBackend:'auto',language:'system',hfTokenEncrypted:'',apiAuthEnabled:false,apiTokenEncrypted:''};}
