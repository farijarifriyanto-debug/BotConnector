...
class Store{
  ...
  defaults(){return {modelsDir:path.join(os.homedir(),'BotConnector AI','models'),runtimeBackend:'auto',language:'system',hfTokenEncrypted:''};}
  ...
  public(){const d={...this.load()};delete d.hfTokenEncrypted;d.hfToken=d.hfToken?'••••••••':'';return d;}
}
