...
function startLlama({binary,modelPath,projector=null,port=11435,gpuLayers=999,context=8192,embedding=false,jinja=true}){
  ...
  current={pid:child.pid,modelPath,projector,binary,port,context,gpuLayers,embedding,args,startedAt:new Date().toISOString()};
