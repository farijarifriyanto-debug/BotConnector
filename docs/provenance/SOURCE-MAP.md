...
LIVE_RUNTIME=Docker container `botconnector-platform-home`, image `botconnector-platform-home:348f3f2-20260906T094839Z` (**CANONICAL CUTOVER COMPLETE 2026-09-06** — built directly from this repo at commit `348f3f2`, immutable commit-based tag; previous tag `tenantization-v1-20260828` retained locally for rollback, digest sha256:80682abba1de...), uvicorn `app.main:app`, port 127.0.0.1:8020
